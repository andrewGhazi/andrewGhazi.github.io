...
This is the Stan model. Essentially just a normally distributed outcome, and the model needs to assess how much variation to ascribe to residual variance versus phylogenetic variance according to the pre-established phylogenetic structure. I also include the *unstable* log-likelihood calculations in the generated quantities:
